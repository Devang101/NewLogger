...
/***/ function(module, exports, __webpack_require__) {
	...
	var LogReducer = function LogReducer() {
	  ...
	  switch (action.type) {
	    case 'ADD_LOG':
	      return [].concat(_toConsumableArray(state), [action.object]);
	    case 'REMOVE_LOG':
	 ...
	 **/
	var store_0 = (0, _redux.createStore)(LogReducer);
	 ...
	 * @return {Object}
	 **/
	var createAddLogAction = function createAddLogAction(log_entry) {
	  return {
	    type: 'ADD_LOG',
	    object: log_entry
	  };
	 ...
	 * @return {Object}
	 **/
	var createRemoveLogAction = function createRemoveLogAction(id) {
	  var index = 0;
	 ...
	 * @param {Object}
	 **/
	var dispatchAdd = function dispatchAdd(log_entry) {
	 ...
	 * @param {Object}
	 **/
	var dispatchRemove = function dispatchRemove(id) {
	 ...
	 **/
	var LogList = _react2.default.createClass({
	  displayName: 'LogList',
	 ...
	 **/
	LogList = (0, _reactRedux.connect)(function mapStateToProps(state) {
	  return { log_entries: state };
	}, function mapDispatchToProps(dispatch) {
	  return {
	    addLog: function addLog(log_entry) {
	      return dispatchAdd(log_entry);
	    },
	    removeLog: function removeLog(id) {
	      return dispatchRemove(id);
	    }
	  };
	})(LogList);
	...
	**/
	ReactDOM.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(LogList, { store: store_0 })
	), document.getElementById('content'));

	dispatchAdd({
	  EventType: "Kobe",
	  EventSeverity: "Lakers",
	  Timestamp: "Today",
	  Message: "I get buckets",
	  id: 1
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getNativeComponentFromComposite = __webpack_require__(192);
